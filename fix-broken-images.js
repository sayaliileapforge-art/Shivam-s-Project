...
async function fixBrokenImages() {
  ...
  try {
    ...
    // These are URLs like: 145_71_Ayansh__jpg (missing leading / and proper extension)
    ...
    if (broken.length > 0) {
      // Delete or clear the broken photo URLs
    ...
    // Also check for data URLs (base64) which are not persistent
